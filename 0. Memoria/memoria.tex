...
\begin{abstract}
Para este TFG se cuenta con datos proporcionados por el Instituto de Investigación sanitaria de Valdecilla. El objetivo de este trabajo será la aplicación de técnicas de minería de datos que proporcionen modelos interpretables por el facultativo médico en relación al tratamiento de pacientes con COVID-19.
\end{abstract}

\renewcommand*\abstractname{Descriptores}
\begin{abstract}
COVID-19, machine learning, python \ldots
\end{abstract}
...
\begin{abstract}
For this TFG there are data provided by the Valdecilla Health Research Institute. The objective of this work will be the application of data mining techniques that provide models that can be interpreted by the medical practitioner in relation to the treatment of patients with COVID-19.
\end{abstract}
