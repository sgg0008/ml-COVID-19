...
\begin{abstract}
Para este TFG se cuenta con datos proporcionados por el Instituto de Investigación Sanitaria de Valdecilla (IDIVAL). El objetivo de este trabajo será la investigación y creación de un modelo de aprendizaje automático que facilite el triaje en la admisión de pacientes con COVID-19.
\end{abstract}
