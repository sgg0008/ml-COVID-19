...
% Datos de portada
\title{Investigación, creación y explotación de modelos para el estudio del COVID-19 en pacientes del Servicio Cántabro de Salud. \newline \newline Documentación Técnica}
\author{Segundo González González}
